...
<!DOCTYPE html>
	...
	<body>
	<?php 
		function header_page()	// function for header files
		{
	?>
		<div id="header">
	...
	<?php 
		 ...
		 function menu()	// function for all common links like search, logout and user and role information
		{
	?>
		...
		function footer_ft()	// function for footer
		{	
